...
use crate::util::{
    chunk_pad, concat, flatten_symmetric_matrix, flatten_vec_vector, msis_h_128_l2,
    mul_matrix_basescalar, shift_right,
};
...
impl<R: PolyRing> CommonReferenceString<R> {
    ...
    fn next_crs(&self) -> Option<CommonReferenceString<R>> {
        ...
        Some(CommonReferenceString::<R>::new(
            r_next,
            n_next,
