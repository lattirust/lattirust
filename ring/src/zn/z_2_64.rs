...
use ark_std::num::Wrapping;
use ark_std::ops::{Add, AddAssign, Mul, MulAssign, Sub, SubAssign};
...
use crate::{ConvertibleRing, Ring, SignedRepresentative, UnsignedRepresentative};
...
impl From<Z2_64> for SignedRepresentative {
    fn from(val: Z2_64) -> Self {
        SignedRepresentative(val.0 .0 as i128)
    }
}

impl From<Z2_64> for UnsignedRepresentative {
    fn from(_val: Z2_64) -> Self {
        unimplemented!()
    }
}
